      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="relative w-full max-w-lg bg-[#0d0d0d] border border-orange-500/20 rounded-[2.5rem] shadow-[0_0_50px_rgba(249,115,22,0.15)] overflow-hidden flex flex-col"
          >
            ...
            <div className="p-8 pt-0 flex flex-col gap-8 relative z-10 overflow-y-auto max-h-[70vh] custom-scrollbar">
              ...
              <div className="flex flex-col items-center py-6 relative">
                ...
                <div className="mt-4 text-center">
                  <motion.span 
                    ...
                    className="text-7xl font-black text-white tabular-nums drop-shadow-2xl"
                  >
                    {streak}
                  </motion.span>
                ...
                <div className="flex justify-between items-center px-1">
                  {weeklyStatus.map((day, i) => (
                    <div key={day.date} className="flex flex-col items-center gap-3">
                      ...
                      >
                        {day.active ? <Zap className="w-5 h-5 fill-white" /> : <div className="w-1.5 h-1.5 rounded-full bg-white/10" />}
                      </motion.div>
            ...
            <div className="p-8 pt-4 border-t border-white/5 bg-white/5 mt-auto">
              <button 
                onClick={onClose}
                className="w-full h-14 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-400 hover:to-red-500 text-white font-black rounded-2xl shadow-[0_10px_30px_rgba(249,115,22,0.3)] active:scale-95 transition-all flex items-center justify-center gap-2 group"
              >
                Keep Going
